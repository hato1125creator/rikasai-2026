...
export type ProgramType = 'class' | 'club' | 'food' | 'stage' | 'exhibition';

// 部活動関連のタイプ（stageとexhibitionを含む）
export const CLUB_RELATED_TYPES: ProgramType[] = ['club', 'stage', 'exhibition'];
